<div class="card-head">
    <h4 class="text-center">1. Compra</h4>
</div>
<div class="row">
	<div class="form-group col-md-3">
        <label for="numero">Número:</label>
        <fieldset disabled>
            <input type="text" class="form-control" name="numero" id="numero" value="{{$nrocompra}}">     
        </fieldset>
	</div>
...
<div class="form-row">
	<div class="form-group col-md-4">
		...
		<select name="id_proveedor" id="id_proveedor" class="custom-select">Seleccionar Proveedor
	...
	<div class="form-group col-md-2">
		<fieldset disabled>
			{{Form::label('proveedor_codigo','Código: ')}}
			<select name="proveedor_codigo" id="proveedor_codigo" class="form-control">Código
			</select>
		</fieldset>
	</div>
...
<div class="form-row">
	<div class="form-group col-md-4">
		{{Form::label('id_empleado','Digitador: ')}}
		<select name="id_empleado" id="id_empleado" class="custom-select">Seleccionar Digitador
...
<div class="form-row">
    <div class="form-group col-md-4">
		...
		<select name="id_sucursal" id="id_sucursal" class="custom-select">Seleccionar Sucursal
	...
	<div class="form-group col-md-4">
		{{Form::label('id_almacen','Seleccionar Almacén: ')}}
		<select name="id_almacen" id="id_almacen" class="custom-select">Seleccionar Almacén
                    ...
                    <div class="form-group col-md-4">
                        <div class="form-group">
                            ...
                            <select name="articulos" id="articulos" class="custom-select" onchange="colocar_precio()">
                                ...
                                <option precio="{{ $value->precio_compra }}" value="{{ $value->id }}">{{ $value->nombre }}
                                </option>
                                @endforeach
                            </select>
                        </div>
